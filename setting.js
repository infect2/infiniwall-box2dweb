...
//input tag handling
var inputWorker = document.getElementById( "useWorkerThread" );
inputWorker.addEventListener( "click", function() {
  var flag = inputWorker.getAttribute( "checked" );
  if( flag === "checked") {
    inputWorker.setAttribute("checked","");
    PEConfig.useWokerThread = false;
  } else {
    inputWorker.setAttribute("checked","checked");
    PEConfig.useWokerThread = true;    
  }
});
